...
namespace FischlWorks_FogWar
{
    ...
    public class csFogWar : MonoBehaviour
    {
        ...
        const float TWEEN_DURATION = 2;
        public void SetFogColor(Color _fc) => DOTween.To(() => fogColor, x => fogColor = x, _fc, TWEEN_DURATION);
        [SerializeField]
        [Range(0, 1)]
        private float fogPlaneAlpha = 1;
        public void SetFogAlpha(float _fa) => DOTween.To(() => fogPlaneAlpha, x => fogPlaneAlpha = x, _fa, TWEEN_DURATION);
